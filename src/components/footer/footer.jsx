      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-2 col-6 mb-4">
            ...
            <a href="frequently-asked-questions.html" className="text-dark d-block mb-3">
              <p>Need Help?</p>
            </a>
          </div>
          ...
          <div className="col-lg-2 col-6 mb-4">
            ...
            <a href="about-us.html" className="text-dark d-block mb-3 textnav">
              <p>About us</p>
            </a>
            <a href="about-us.html" className="text-dark d-block mb-3 textnav">
              <p>Contact</p>
            </a>
            <a href="blog-details.html" className="text-dark d-block mb-3">
              <p>Blogs</p>
            </a>
            <a href="#" className="text-dark d-block mb-3">
              <p>Size Chart</p>
